...
program.addHelpText(
  ...
  [
    ...
    `  ${chalk.cyan("4.")} Generate favicon files and replace existing favicon references automatically.`,
    "",
    ui.title("Examples"),
...
setCommand.addHelpText(
  ...
  [
    ...
    `  ${chalk.cyan("4.")} Pick an image (.png, .jpg, .jpeg, .webp, .svg), then generate and replace existing references.`,
    "",
    ui.title("Examples"),
    `  ${ui.accent("$")} favicli set`,
    `  ${ui.accent("$")} favicli set -d .`,
